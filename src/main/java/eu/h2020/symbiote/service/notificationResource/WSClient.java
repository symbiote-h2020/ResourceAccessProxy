...
public class WSClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            session = container.connectToServer(WSClient.class, URI.create("ws://localhost:8100/notification"));

            session.getBasicRemote().sendText("[1641948959]");

            messageLatch.await(60 * 10, TimeUnit.SECONDS);
