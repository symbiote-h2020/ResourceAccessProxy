...
import eu.h2020.symbiote.validation.value.Value;
import eu.h2020.symbiote.validation.value.ValueDeserializer;
...
public class ValidationUtils {
    ...
    public static Resource getResourceDescription(HttpClient httpClient, String registrationHandlerUrl, String internalId) throws UnsupportedEncodingException, IOException {
        ...
        String encodedUrl = registrationHandlerUrl + "/resource?" + ValidationUtils.UrlEncode("resourceInternalId=" + internalId);
